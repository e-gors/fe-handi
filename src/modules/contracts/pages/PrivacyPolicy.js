  ...
  return (
    <Box sx={{ mt: 8, p: 1, textAlign: "justify" }}>
      ...
      <Typography sx={styles.description}>
        ...
        number, and billing information when you create an account and use our
        platform. We may also collect non-personal information such as your IP
        address and browser type for website analytics purposes.
      </Typography>
      ...
      <Typography sx={styles.header}>How We Share Your Information</Typography>
      <Typography sx={styles.description}>
        ...
        hosting. We may also disclose your information if required by law or in
      ...
      <Typography sx={styles.description}>
        ...
        you with our services and as required by law. When you delete your
        account, we will delete your personal information within a reasonable
        time frame, unless we are required to retain it for legal or business
        purposes.
      </Typography>
      ...
      <Typography sx={styles.description}>
        ...
        communications by following the instructions in the emails we send you.
      </Typography>
      ...
      <Typography sx={styles.description}>
        ...
        will post any changes on our website and notify you by email if you have
